 ...
 */
public class MainTabMainPage_Read {
    public MainTabMainPage_Read(String account, String token, final SuccessCallback successCallback, final FailCallback failCallback)
    {
                        ...
                        case Config.RESULT_STATUS_SUCCESS:
                            if(successCallback!=null)
                            {
                                ...
                                for(int i=0;i<jsonArray.length();i++)
                                {
                                    ...
                                    try {
                                     date=   simpleDateFormat.parse(object.getString(Config.KEY_OFFICIAL_TIME));
        ...
        },Config.KEY_ACTION,Config.ACTION_LOAD_TO_BE_READ,Config.KEY_ACCOUNT,account,Config.KEY_TOKEN,token);
    }
